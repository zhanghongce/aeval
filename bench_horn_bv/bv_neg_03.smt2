...
; negation via subtraction from 0

(rule (=> (and (= i #x0001) (= a #x0000) (not c) (= d #x0000)) (inv a b i c d)))
...
(rule (=>
  (and
    ...
    (or
      ...
      (and (= (bvand i a) #x0000) (= (bvand i b) #x0000) c c1 (= d1 (bvor d i)))
      (and (= (bvand i a) #x0000) (= (bvand i b) i) (not c) c1 (= d1 (bvor d i)))
      (and (= (bvand i a) i) (= (bvand i b) #x0000) (not c) (not c1) (= d1 (bvor d i)))
      (and (= (bvand i a) i) (= (bvand i b) #x0000) c (not c1) (= d1 d))
      (and (= (bvand i a) #x0000) (= (bvand i b) i) c c1 (= d1 d))
      (and (= (bvand i a) i) (= (bvand i b) i) (not c) (not c1) (= d1 d))
      (and (= (bvand i a) i) (= (bvand i b) i) c c1 (= d1 (bvor d i)))
    )
    (= i1 (ite (= i #x8000) #xffff (bvshl i #x0001))))
  (inv a1 b1 i1 c1 d1)))

(rule (=> (and (inv a b i c d) (= i #xffff) (not (= d (bvneg b)))) fail))
